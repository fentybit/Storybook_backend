...
event_1 = Event.create(title: 'Fun Day at the Dog Park', vibe: '1 rad', date: '2021-05-10', time: '2021-05-10 12:00:00', location: '12604 Bluff Creek Dr, Los Angeles, CA 90094', latitude: '33.9752466', longitude: '-118.4156689', description: 'Dog having too much fun, and he could not control himself. Maybe I need to take him to another dUser.og park to see how he is doing, he pooped twice.', category_id: first_category.id, user_id: user.id)
...
event_3 = Event.create(title: 'Birthday Din Din!', vibe: '1 rad', date: '2021-05-01', time: '2021-05-01 18:00:00', location: 'Lawry\'s', latitude: '33.9158844', longitude: '-118.413313', description: 'I love cheese, especially airedale queso. Cheese and biscuits halloumi cauliflower cheese cottage cheese swiss boursin fondue caerphilly. Cow port-salut camembert de normandie macaroni cheese feta who moved my cheese babybel boursin. Red leicester roquefort boursin squirty cheese jarlsberg blue castello caerphilly chalk and cheese. Lancashire.', category_id: second_category.id, user_id: user.id)
...
event_6 = Event.create(title: 'Date night at Mercado', vibe: '5 awful', date: '2021-05-21', time: '2021-05-21 19:00:00', location: '3212A N Sepulveda Blvd, Manhattan Beach, CA 90266', latitude: '33.8992204', longitude: '-118.3962446', description: 'Zombie ipsum reversus ab viral inferno, nam rick grimes malum cerebro. De carne lumbering animata corpora quaeritis. Summus brains sit , morbo vel maleficia? De apocalypsi gorger omero undead survivor dictum mauris. Hi mindless mortuis soulless creaturas, imo evil stalking monstra adventus resi dentevil vultus comedat cerebella viventium.', category_id: second_category.id, user_id: user.id)
